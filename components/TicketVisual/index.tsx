...
import TicketColoredMobile from '../TicketColoredMobile';
import TicketColored from '../TicketColored';
import styles from './styles.module.css';
import TicketProfile from '../TicketProfile';
import TicketNumber from '../TicketNumber';
import TicketMono from '../TicketMono';
import TicketInfo from '../TicketInfo';
import TicketMonoMobile from '../TicketMonoMobile';
